 ...
 */
final class Version20220815161944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account CHANGE oidc_identifier password VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account CHANGE password oidc_identifier VARCHAR(255) NOT NULL');
    }
}
